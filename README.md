...
* Compares the local test scripts (`scripts/`) to the files shared within the `config_chan` Channel
...
* Publishes a list of the tests being ignored to its device channel
